...
class CEXIMReceiptType02(CEXIMReceiptType):
    ...
    def get_receipt(self) -> Receipt:
        ...
        receipt.payer_account_name = self._get_name(self.table.get_cell(0, 0).get_value())  # 付款人户名
        receipt.payer_account_number = self._get_account(self.table.get_cell(0, 1).get_value())  # 付款人账号
