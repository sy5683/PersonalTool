...
class CCBReceiptType04(CCBReceiptType):
    ...
    def get_receipt(self) -> Receipt:
        ...
        receipt.payee_account_name = self._get_account(self.table.get_cell(0, 0).get_value())  # 收款人户名
        receipt.payee_account_number = self._get_account(self.table.get_cell(0, 1).get_value())  # 收款人账号
