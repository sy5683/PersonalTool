...
class CCBReceiptType01(CCBReceiptType):
    ...
    def get_receipt(self) -> Receipt:
        ...
        if name_row_values[0] == "付款人":
            ...
            receipt.payer_account_number = self.__get_account(self.table.get_row_values(3)[0])  # 付款人账号
            receipt.payee_account_name = self.__get_name(name_row_values[3])  # 收款人户名
            receipt.payee_account_number = self.__get_account(self.table.get_row_values(3)[1])  # 收款人账号
        elif name_row_values[0] == "收款人":
            receipt.payer_account_name = self.__get_name(name_row_values[3])  # 付款人户名
            receipt.payer_account_number = self.__get_account(self.table.get_row_values(3)[1])  # 付款人账号
            receipt.payee_account_name = self.__get_name(name_row_values[1])  # 收款人户名
            receipt.payee_account_number = self.__get_account(self.table.get_row_values(3)[0])  # 收款人账号
