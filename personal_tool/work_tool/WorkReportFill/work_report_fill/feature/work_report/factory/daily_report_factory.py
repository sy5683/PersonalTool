...
class DailyReportFactory:
    ...
    @staticmethod
    def row_values_to_daily_report(row_values: typing.List[typing.Union[str, datetime.datetime]],
                                   time_format: str) -> DailyReport:
        daily_report = DailyReport()
        daily_report.date = ExcelUtil.format_date_data(row_values[1], time_format)  # 日期
