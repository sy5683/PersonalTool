...
class DownloadDriver:
    ...
    def get_chrome_driver_path(cls) -> str:
        ...
        try:
            ...
            chrome_version = cls.__get_browser_version("Software\\Google\\Chrome\\BLBeacon")
    ...
    def get_edge_driver_path(cls) -> str:
        ...
        try:
            ...
            edge_version = cls.__get_browser_version("Software\\Microsoft\\Edge\\BLBeacon")
    ...
    @staticmethod
    def __get_browser_version(regedit_path: str) -> str:
        """获取注册表的值"""
